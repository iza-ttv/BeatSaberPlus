...
namespace BeatSaberPlus_ChatRequest
{
    internal class CRConfig : CP_SDK.Config.JsonConfig<CRConfig>
    {
        ...
        internal class _Commands
        {
            ...
            [JsonProperty] internal string      BSRHelpCommand_Reply        = "@$UserName To request a song, go to https://beatsaver.com/search and find a song, Click on the Exclamation Point (!) next to the song and paste this in the stream chat and I'll play it soon!.";
        ...
        [JsonProperty] internal bool RoundRobin = false;
